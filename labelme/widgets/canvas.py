...
class Canvas(QtWidgets.QWidget):
    ...
    #     # Get the dimensions of the QLabel and the QWidget
    #     label_size = self.label.sizeHint()
    #     canvas_width = self.width()
    #     canvas_height = self.height()
    #
    #     # Calculate the position to center the QLabel
    #     x = (canvas_width - label_size.width()) // 2
    #     y = (canvas_height - label_size.height()) // 2
    #
    #     # Move the QLabel to the calculated position
    #     self.label.move(x, y - 200)

    # def resizeEvent(self, event):
    #     # Re-center the QLabel when the QWidget is resized
    #     self.centerLabel()
